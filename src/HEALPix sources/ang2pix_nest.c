...
//Note, I (JP) have modified the name of this routine to avoid
//a clash with an hpic function name

inline void heal_ang2pix_nest( const long nside, double theta, double phi, long *ipix) {
