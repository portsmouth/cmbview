...
*/
{
    ...
    int fitsio_extend = 1;     /* may FITS file have extensions?           */

    ffphpr(fptr, simple, bitpix, naxis, naxes, pcount, gcount, fitsio_extend, status);
    return(*status);
}
/*--------------------------------------------------------------------------*/
int ffphpr( fitsfile *fptr, /* I - FITS file pointer                        */
            ...
            int fitsio_extend,     /* I - may FITS file have extensions?           */
            int *status)    /* IO - error status                            */
/*
...
*/
{
    ...
    if ((fptr->Fptr)->curhdu == 0)  /* the primary array */
    {
        if (fitsio_extend)
        {
            ...
            ffpkyl(fptr, "EXTEND", fitsio_extend, comm, status);
        }
